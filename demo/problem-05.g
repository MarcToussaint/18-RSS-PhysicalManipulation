...
frame blueBall (table1) { size=[.1 .1 .1 .05] color=[.2 .2 .8] shape=ST_ssBox contact
 from=<T t(0 0 .02) t(-.3 .5 .05)> joint=JT_rigid , logical={ object } }

### tools

body stick1 {}
joint (table1 stick1) { from=<T t(0 0 .02) t(-.5 -.5 .03)> type=JT_rigid}
shape stick(stick1) { type=ST_ssBox size=[.8 .07 .07 .03] color=[.6 .3 0] contact, logical={ object } }
